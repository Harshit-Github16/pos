          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <button
                ...
                className="flex items-center cursor-pointer space-x-2 px-3 py-2 text-sm font-medium text-gray-700 transition-all duration-200 rounded-lg hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
              >
